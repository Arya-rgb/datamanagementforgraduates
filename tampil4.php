...
<h2>STMIK BANDUNG</h2>
<h3><a href="form_mahasiswa.php">Tambah Calon Wisudawan</a></h3>
</div>
    <br>
    ...
    echo "<td><a href='form_wisudawan.php?tahun_angkatan=$user_data[tahun_angkatan]&nim=$user_data[nim]'>Aktivasi</a></td></tr>";
